...
class Trebuchet < Thor
  ...
  method_option :username, :aliases => '-u', :desc => "Username for the host targeted"
  method_option :password, :aliases => '-p', :desc => "Password for the host targeted"
  method_option :host,     :aliases => '-h', :desc => "Host of the targeted server"
  ...
  method_option :name,     :aliases => '-n', :desc => "Name for the siege"
